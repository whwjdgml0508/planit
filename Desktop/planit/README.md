...
#### ⏱️ 학습 세션
- **학습 시간 기록**: 시작/종료 시간 기반 학습 시간 측정
- **효과성 평가**: 1-5점 학습 효과성 자체 평가
- **과목/과제 연동**: 특정 과목이나 과제와 연결하여 기록
...
#### 💬 학과별 소통 공간
- **9개 카테고리**: 학습자료, 시험정보, 강의특성, 체력평가, 영어상식, 프로젝트, 질문답변, 자유게시판, 공지사항
- **게시글 유형**: 일반/질문/공지/팁 게시글 구분
- **학과별 권한**: 특정 학과만 접근 가능한 비공개 게시판
