#!/usr/bin/env python3
"""
Production 서버의 데이터베이스 설정을 SQLite로 변경
"""
...
# Cache settings - Disable Redis for simplicity
CACHES = {
    'default': {
...
print("Production settings content created")
print("Length:", len(production_settings))
